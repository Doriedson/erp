...
class Printer
{
     ...
     */
    public function close($copies) {

        $this->connector->finalize($copies);
    }
    ...
    /**
     * @return null|array PrintBuffer
     */
    public function getPrintBuffer()
    {
        return $this->buffer_raw;
    }
