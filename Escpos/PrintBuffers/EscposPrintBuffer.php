...
class EscposPrintBuffer implements PrintBuffer
{
     ...
     */
    private function loadAvailableCharacters(CapabilityProfile $profile = null)
    {
        /** CapabilityProfile $profile = null => For compatility with Obfuscate */
        // CapabilityProfile::loadCapabilitiesDataFile();
        // $profile = new CapabilityProfile('default', CapabilityProfile::$profiles['default']);
        /** --------------- */
     ...
     * @param string $data
     */
    private function write(string $data, PrintConnector $printer = null)
    {
        /** PrintConnector $printer = null => For compatibility with Obfuscate */

        $printer = $this -> printer -> getPrintConnector();
        $printer -> write($data);
    }
